...
public class EventController {
    ...
    public ResponseEntity<Void> pageView(PageViewEvent request) {
    ...
    //Track user clicks
    @PostMapping("/click")
    public ResponseEntity<Void> click(ClickEvent request) {
    ...
    public ResponseEntity<Void> purchase(PurchaseEvent request) {
